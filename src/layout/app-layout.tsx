...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Company', path: '/companies', entity: 'company', service: AccessServiceEnum.PROJECT, icon: FiBox },
  { name: 'Contract', path: '/contracts', entity: 'contract', service: AccessServiceEnum.PROJECT, icon: FiFileText },
